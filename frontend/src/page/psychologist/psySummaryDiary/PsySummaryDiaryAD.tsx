                            ...
                            <div className='contentMain'>
                                ...
                                <div className="showBook">
                                    ...
                                    <div className='cardEmotion'>
                                        <FilterEmotionsActivity diaryID={numericDiaryID} date={selectedDate ? dayjs(selectedDate).format('DD-MM-YYYY') : ''} />
                                    </div>
                                </div>
                                    <DateEmotionBar diaryID={numericDiaryID} date={selectedDate ? dayjs(selectedDate).format('DD-MM-YYYY') : ''} />
...
export default PsySummaryDiaryAD